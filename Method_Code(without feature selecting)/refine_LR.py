...
torch.save(model, '../model/refine_LR_model.pth')

val_results.to_csv('../Results/refine_LR_predictions.csv', index=False)
loss_records.to_csv('../Results/refine_LR_loss_records.csv', index=False)
...
plt.savefig('../Results/refine_LR_loss.png')
plt.show()
writer.close()
