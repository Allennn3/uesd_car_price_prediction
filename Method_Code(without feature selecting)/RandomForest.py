...
# 保存结果
train_results.to_csv('../Results/RF_train_predictions.csv', index=False)
val_results.to_csv('../Results/RF_val_predictions.csv', index=False)
...
loss_pd.to_csv('../Results/RF_loss_pd.csv', index=False)
...
plt.savefig('../Results/RF_loss.png')
plt.show()
