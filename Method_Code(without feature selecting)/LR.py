...
val_results.to_csv('../Results/LR_predictions.csv', index=False)
loss_records.to_csv('../Results/LR_loss_records.csv', index=False)
...
loss_pd.to_csv('../Results/LR_loss_pd.csv', index=False)
...
plt.savefig('../Results/LR_loss.png')
plt.show()
writer.close()
