...
val_results.to_csv('../New_Results/MLP_predictions.csv', index=False)
loss_records.to_csv('../New_Results/MLP_loss_records.csv', index=False)
...
loss_pd.to_csv('../New_Results/MLP_loss_pd.csv', index=False)
...
plt.savefig('../New_Results/MLP_loss.png')
plt.show()
writer.close()
